...
function VideoCard({ displayVideo, setDeleteVideoStatus }) {
    ...
    const handleShow = async() => {
        ...
        const today=new Date(); //to get current date of deletion
        ...
        return (
            <>
                <Card style={{ width: '100%', height: '350px' }} className='mt-5 mb-5' draggable onDragStart={(e)=>dragstarted(e,displayVideo.id)}>
                    <Card.Img variant="top" height="250px" src={displayVideo.url} onClick={handleShow} />
                ...
                >
                    ...
                    <Modal.Body>
                        <iframe width="480" height="480" src={displayVideo.embededLink} frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                    </Modal.Body>
                    <Modal.Footer>
